...
#GridRes=r05_r05   # 0.5 degree 0-360  # domain file mismatch causing >400k error
GridRes=hcru_hcru
...
# 
CurDate=`date '+%Y-%m-%d'`
RunName=ad_spinup_EXPAI_RUBISCO_CMIP6
...
&elm_inparm
    ...
    hist_fincl1 = 'PPOOL','EFLX_LH_TOT','RETRANSN','PCO2','PBOT','NDEP_TO_SMINN','OCDEP','BCDEP','COL_FIRE_CLOSS','HDM','LNFM','NEE','GPP','FPSN',\
                  ...
                  'TOTVEGC','N_ALLOMETRY','P_ALLOMETRY','TOTCOLC','TOTECOSYSC', 'TOTLITC','BTRAN','SCALARAVG_vr','CWDC','QVEGE','QVEGT','QSOIL','QDRAI','QRUNOFF','FPI',\
