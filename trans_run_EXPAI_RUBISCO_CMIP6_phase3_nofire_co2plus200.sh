...
#*** change to your src code directory
E3SMCimeDir=/global/homes/m/minxu/MyGit/e3sm_v3/cime/scripts/

#*** change to your E3SM case directory and simulation directory
...
CurDate=`date '+%Y-%m-%d'`
RunName=trans_EXPAI_RUBISCO_CMIP6_phase3_co2plus200
...
#*** point the ph2dir to Min Xu's simulation directory (/pscratch/sd/m/minxu/E3SM_simulations), 
#*** so you could use the phase 2 restart files 
...
for ni in `seq 1 $numinst`; do 
    ...
    #*** keep one of following 4 lines uncomment to run 36 instances with regard to the amb, +100, +200, and +400 [CO2]
   #/bin/cp -f /global/homes/m/minxu/MyGit/MySrc/run_scripts_e3sm/datm_expai/user_datm.streams.txt.co2tseries.20tr         user_datm.streams.txt.co2tseries.20tr_${strinst}
   #/bin/cp -f /global/homes/m/minxu/MyGit/MySrc/run_scripts_e3sm/datm_expai/user_datm.streams.txt.co2tseries.20tr_plus100 user_datm.streams.txt.co2tseries.20tr_${strinst}
    /bin/cp -f /global/homes/m/minxu/MyGit/MySrc/run_scripts_e3sm/datm_expai/user_datm.streams.txt.co2tseries.20tr_plus200 user_datm.streams.txt.co2tseries.20tr_${strinst}
   #/bin/cp -f /global/homes/m/minxu/MyGit/MySrc/run_scripts_e3sm/datm_expai/user_datm.streams.txt.co2tseries.20tr_plus400 user_datm.streams.txt.co2tseries.20tr_${strinst}
...
# multi-instance setup
#*** change to the location of the repo of this script
