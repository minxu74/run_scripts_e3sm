...
/bin/cp -f $BaseCaseDir/${FnspinupCase}/run/$FnspinupCase.datm.rs1.0710-01-01-00000.bin ./run/
/bin/cp -f $BaseCaseDir/${FnspinupCase}/run/$FnspinupCase.cpl.r.0710-01-01-00000.nc ./run/
/bin/cp -f $BaseCaseDir/${FnspinupCase}/run/$FnspinupCase.clm2.r.0710-01-01-00000.nc ./run/
